...
export class ExternFilesProvider {
  ...
  private initElectronFileCalls() {
    ...
    this.renameFile = this._electronRenameFile;
  ...
  private initCordovaFileCalls() {
    ...
    this.renameFile = this._cordovaRenameFile;
  ...
  private _electronRenameFile(path,fileName,newPath,newFileName) {
    this.fileCalls.renameSync(path + '/'+fileName,newPath + '/'+newFileName)
  }
  ...
  private _cordovaRenameFile(path,fileName,newPath,newFileName) {
    this.fileCalls.moveFile(path,fileName,newPath,newFileName)
  }
  ...
  renameFile(path,fileName, newPath,newFileName) {}
  /**
